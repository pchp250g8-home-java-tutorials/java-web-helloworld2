HelloWorld2. Java tutorials. Web Application. Simple Html Page. Simple Java Server Page. Simple Java Servlet.
The web application consists of a start page with the file name "index.html" and a server web page with the file name "HelloWorld.jsp"
and a web controller (servlet) file named "HelloWorld.java". 
...
HelloWorld2. Занятия по Java. Веб приложение. Простая HTML Страница. Простая Серверная Страница на Java. Простой Сервлет.
Веб приложение состоит из стартовой страницы с именем файла "index.html", серверной веб страницы с именем файла "HelloWorld.jsp" 
и файла веб котроллера с именем "HelloWorld.java".
